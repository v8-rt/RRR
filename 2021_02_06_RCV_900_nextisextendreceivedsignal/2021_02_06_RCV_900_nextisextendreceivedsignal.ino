/*
   Alt+Num...
   ☺☻♥♦♣♠•◘○◙ (1-10)   ♂♀♪♫☼►◄↕‼¶ (11-20)   §▬↨↑↓→←∟↔▲ (21-30)   ▼ !"#$%&'( (31-40)   )*+,-./012 (41-50)
   3456789:;< (51-60)   =>?@ABCDEF (61-70)   GHIJKLMNOP (71-80)   QRSTUVWXYZ (81-90)   [\]^_`abcd (91-100)
   efghijklmn (101-110)   opqrstuvwx (111-120)   yz{|}~⌂Çüé (121-130)   âäàåçêëèïî (131-140)   ìÄÅÉæÆôöòû (141-150)
   ùÿÖÜø£Ø×ƒá (151-160)   íóúñÑº¿®¬ (161-170)   ½¼¡«»░▒▓│┤(171-180)   ÁÂÀ©╣║╗╝¢¥ (181-190)   ┐└┴┬├─┼ãÃ╚ (191-200)
   ╔╩╦╠═╬¤ðÐÊ (201-210)   ËÈıÍÎÏ┘┌█▄ (211-220)   ¦Ì▀ÓßÔÒõÕµ (221-230)   þÞÚÛÙýÝ¯´­ (231-240)   ±‗¾¶§÷¸°¨· (241-250)
   ¹³²■ ☺☻♥♦ (251-260)
   ...
   ║◙║◙║◙║ *  *  *  *  ║◘║◘║◘║
   ╚═╩═╩═╝ *  *  *  *  ╚═╩═╩═╝
   10=◙ 20=¶ 30=▲ 40=( 50=2 60=< 70=F 80=P 90=Z 100=d 110=n 120=x 130=é 140=î 150=û 160=á 170=¬ 180=┤ 190=¥ 200=╚ 210=Ê 220=▄ 230=µ 240=­ 250=· 260=♦ 254=■
*/
#include "heltec.h"
